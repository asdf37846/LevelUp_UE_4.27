...
#define UE_PROJECT_NAME LevelUp_Vehicle
#define UE_TARGET_NAME LevelUp_VehicleEditor
#define UE_MODULE_NAME "LevelUp_Vehicle"
...
#define LEVELUP_VEHICLE_API DLLEXPORT
